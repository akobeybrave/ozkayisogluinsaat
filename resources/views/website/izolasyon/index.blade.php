        ...
        <div class="card-body">
            ...
            <ul class="nav nav-pills nav-fill mt-4" role="tablist">
                <li class="nav-item">
                    <a
                        ...
                        role="tab"
                    >
                        <span>İzolasyon Ön Yüz Metinler</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a
                        ...
                        role="tab"
                    >
                        <span>İzolasyon Ön Yüz Resimler</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a
                        ...
                        role="tab"
                    >
                        <span>İzolasyon Sayfa Metinler</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a
                        ...
                        role="tab"
                    >
                        <span>İzolasyon Sayfa Resimler</span>
                    </a>
                </li>
            </ul>
            <!-- Tab panes -->
            <div class="tab-content border mt-2">
                ...
                >
                    ...
                    <div class="izolasyonFrontImages">
                        ...
                        <form method="post" action="{{ route("website.izolasyon-resim1-update") }}" class="mt-6" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                @if ($izolasyon->frontimage1)
                                    <div class="mt-3">
                                        <img id="image-preview1" src="{{ asset($izolasyon->frontimage1) }}"  alt="resim" style="width: 200px; height: auto; margin-top: 10px;">
                                    </div>
                                @endif
                            </div>
                            <button type="submit" class="btn btn-success font-medium px-4 d-flex align-items-center justify-content-between gap-2">
                        ...
                        <form method="post" action="{{ route("website.izolasyon-resim2-update") }}" class="mt-6" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                @if ($izolasyon->frontimage2)
                                    <div class="mt-3">
                                        <img id="image-preview2" src="{{ asset($izolasyon->frontimage2) }}" alt="resim" style="width: 200px; height: auto; margin-top: 10px;">
                                    </div>
                                @endif
                            </div>
                            <button type="submit" class="btn btn-success font-medium px-4 d-flex align-items-center justify-content-between gap-2">
                        ...
                        <form method="post" action="{{ route("website.izolasyon-resim3-update") }}" class="mt-6" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                @if ($izolasyon->frontimage3)
                                    <div class="mt-3">
                                        <img id="image-preview3" src="{{ asset($izolasyon->frontimage3) }}" alt="resim" style="width: 200px; height: auto; margin-top: 10px;">
                                    </div>
                                @endif
                            </div>
                            <button type="submit" class="btn btn-success font-medium px-4 d-flex align-items-center justify-content-between gap-2">
                ...
                >
                    ...
                    <form method="post" action="{{ route("website.izolasyon-page-update") }}" class="mt-6" enctype="multipart/form-data">
                        @csrf

                        <div class="mb-4">
                            <label for="pagedescription" class="form-label">Sayfa Açıklama</label>
                            <textarea  class="form-control @error('pagedescription') is-invalid @enderror" name="pagedescription" rows="8" cols="6">{{ $izolasyon->pagedescription }}</textarea>
