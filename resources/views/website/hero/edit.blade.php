        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="post" action="{{ route("website.heroes.update", $hero->id) }}" class="mt-6" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            <label for="hero_title" class="form-label fw-semibold aktext">Başlık</label>
                            <input type="text" name="hero_title" value="{{ $hero->hero_title }}" class="form-control @error('hero_title') is-invalid @enderror">
                            @error('hero_title')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="hero_subtitle" value="{{ $hero->hero_subtitle }}" class="form-control @error('hero_subtitle') is-invalid @enderror">
                            @error('hero_subtitle')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="hero_slogan" value="{{ $hero->hero_slogan }}" class="form-control @error('hero_slogan') is-invalid @enderror">
                            @error('hero_slogan')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
