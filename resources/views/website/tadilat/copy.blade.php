...
@section('content')
    ...
    <div class="container">
        ...
        <div style="text-align: center">
            <h3 class="mb-0">TADİLAT ÖN SAYFA DÜZENİ</h3>
        </div>
                        ...
                        <form method="post" action="{{ route("website.tadilat-resim1-update") }}" class="mt-6" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                @if ($tadilat->frontimage1)
                                    <div class="mt-3">
                                        <img class="w-100" id="image-preview1" src="{{ asset($tadilat->frontimage1) }}"  alt="resim" style="width: 200px; height: auto; margin-top: 10px;">
                                    </div>
                                @endif
                            </div>
                            <button type="submit" class="btn btn-success font-medium px-4 d-flex align-items-center justify-content-between gap-2">
                        ...
                        <form method="post" action="{{ route("website.tadilat-resim2-update") }}" class="mt-6" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                @if ($tadilat->frontimage2)
                                    <div class="mt-3">
                                        <img class="w-100" id="image-preview2" src="{{ asset($tadilat->frontimage2) }}" alt="resim" style="width: 200px; height: auto; margin-top: 10px;">
                                    </div>
                                @endif
                            </div>
                            <button type="submit" class="btn btn-success font-medium px-4 d-flex align-items-center justify-content-between gap-2">
                        ...
                        <form method="post" action="{{ route("website.tadilat-resim3-update") }}" class="mt-6" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                @if ($tadilat->frontimage3)
                                    <div class="mt-3">
                                        <img class="w-100" id="image-preview3" src="{{ asset($tadilat->frontimage3) }}" alt="resim" style="width: 200px; height: auto; margin-top: 10px;">
                                    </div>
                                @endif
                            </div>
                            <button type="submit" class="btn btn-success font-medium px-4 d-flex align-items-center justify-content-between gap-2">
