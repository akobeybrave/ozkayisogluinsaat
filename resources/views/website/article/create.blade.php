        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="post" action="{{ route("admin.articles.store") }}" class="mt-6" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('text') is-invalid @enderror" name="text" rows="6" cols="6">{{ old("text") }}</textarea>
                            @error('text')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
