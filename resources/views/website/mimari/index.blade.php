        ...
        <div class="card-body">
            ...
            <ul class="nav nav-pills nav-fill mt-4" role="tablist">
                <li class="nav-item">
                    <a
                        ...
                        role="tab"
                    >
                        <span>Mimari Ön Yüz Metinler</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a
                        ...
                        role="tab"
                    >
                        <span>Mimari Ön Yüz Resimler</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a
                        ...
                        role="tab"
                    >
                        <span>Mimari Sayfa Metinler</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a
                        ...
                        role="tab"
                    >
                        <span>Mimari Sayfa Resimler</span>
                    </a>
                </li>
            </ul>
            <!-- Tab panes -->
            <div class="tab-content border mt-2">
                ...
                >
                    ...
                    <form method="post" action="{{ route("website.mimari-update") }}" class="mt-6" enctype="multipart/form-data">
                        @csrf

                        <div class="mb-3">
                            <label for="title" class="form-label fw-semibold aktext">Üst Başlık</label>
                            <input type="text" name="title" value="{{ $mimari->title }}" class="form-control @error('title') is-invalid @enderror">
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea  class="form-control @error('description') is-invalid @enderror" name="description" rows="4" cols="6">{{ $mimari->description }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="subtitle1" value="{{ $mimari->subtitle1 }}" class="form-control @error('subtitle1') is-invalid @enderror">
                            @error('subtitle1')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea  class="form-control @error('description1') is-invalid @enderror" name="description1" rows="4" cols="6">{{ $mimari->description1 }}</textarea>
                            @error('description1')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="subtitle2" value="{{ $mimari->subtitle2 }}" class="form-control @error('subtitle2') is-invalid @enderror">
                            @error('subtitle2')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <textarea  class="form-control @error('description2') is-invalid @enderror" name="description2" rows="4" cols="6">{{ $mimari->description2 }}</textarea>
                            @error('description2')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="subtitle3" value="{{ $mimari->subtitle3 }}" class="form-control @error('subtitle3') is-invalid @enderror">
                            @error('subtitle3')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea  class="form-control @error('description3') is-invalid @enderror" name="description3" rows="4" cols="6">{{ $mimari->description3 }}</textarea>
                            @error('description3')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                >
                    ...
                    <div class="mimariFrontImages">


                        <form method="post" action="{{ route("website.mimari-resim1-update") }}" class="mt-6" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group mb-3">
                                ...
                                @if ($mimari->frontimage1)
                                    <div class="mt-3">
                                        <img id="image-preview1" src="{{ asset($mimari->frontimage1) }}"  alt="resim" style="width: 200px; height: auto; margin-top: 10px;">
                                    </div>
                                @endif
                            </div>
                            <button type="submit" class="btn btn-success font-medium px-4 d-flex align-items-center justify-content-between gap-2">
                        ...
                        <form method="post" action="{{ route("website.mimari-resim2-update") }}" class="mt-6" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group mb-3">
                                <label for="frontimage2">Önsayfa Resim 2</label>
                                <input type="file" name="frontimage2" id="image2" class="form-control" accept="image/*">
                                @if ($mimari->frontimage2)
                                    <div class="mt-3">
                                        <img id="image-preview2" src="{{ asset($mimari->frontimage2) }}" alt="resim" style="width: 200px; height: auto; margin-top: 10px;">
                                    </div>
                                @endif
                            </div>
                            <button type="submit" class="btn btn-success font-medium px-4 d-flex align-items-center justify-content-between gap-2">
                        ...
                        <form method="post" action="{{ route("website.mimari-resim3-update") }}" class="mt-6" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group mb-3">
                                <label for="frontimage3">Önsayfa Resim 3</label>
                                <input type="file" name="frontimage3" id="image3" class="form-control" accept="image/*">
                                @if ($mimari->frontimage3)
                                    <div class="mt-3">
                                        <img id="image-preview3" src="{{ asset($mimari->frontimage3) }}" alt="resim" style="width: 200px; height: auto; margin-top: 10px;">
                                    </div>
                                @endif
                            </div>
                            <button type="submit" class="btn btn-success font-medium px-4 d-flex align-items-center justify-content-between gap-2">
                ...
                >
                    ...
                    <form method="post" action="{{ route("website.mimari-page-update") }}" class="mt-6" enctype="multipart/form-data">
                        @csrf

                        <div class="mb-4">
                            <label for="pagedescription" class="form-label">Sayfa Açıklama</label>
                            <textarea  class="form-control @error('pagedescription') is-invalid @enderror" name="pagedescription" rows="8" cols="6">{{ $mimari->pagedescription }}</textarea>
                ...
                >
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="{{ route("website.mimari-images-store") }}" class="mt-6" enctype="multipart/form-data">
                                @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('website.mimari-images-delete') }}" method="POST">
                                @csrf
                                @method('DELETE')
                                ...
                                <br>
                                <hr>
                                <div class="mimariBackImages">
                                    @foreach($mimariImages->chunk(4) as $chunk)
