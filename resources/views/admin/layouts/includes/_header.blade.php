<header class="app-header" style="background-color: #202D42">
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="d-block d-lg-none">
            <img src="{{ asset("uploads/logos/logo.png") }}" width="32" alt="" />
        </div>
                        ...
                        <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop1">
                            <div class="profile-dropdown position-relative" data-simplebar>
                                ...
                                <div class="message-body">
                                    <a href="{{ route("admin.users.edit", Auth::user()->id) }}" class="py-2 px-7 mt-2 d-flex align-items-center">
                                        <h6 class="mb-1 bg-hover-primary fw-semibold"> Profil Düzenle </h6>
                                    </a>
                                </div>

                                <div class="message-body">
                                    <a href="{{ route("admin.users.change-password", Auth::user()->id) }}" class="py-2 px-7 mt-2 d-flex align-items-center">
                                        <h6 class="mb-1 bg-hover-primary fw-semibold"> Parola Değiştir </h6>
                                    </a>
                                </div>
